    ...
    <div class="container g-pt-100">
        ...
        <div class="col-sm-5 col-md-3 ml-auto g-mb-30 g-mb-0--sm">
          ...
          <ul class="list-unstyled g-color-gray-dark-v5 g-font-size-13">
            ...
            <li class="media my-3">
              ...
              <div class="media-body">
                sushi@furusato.com.ar
              </div>
            </li>
            <li class="media my-3">
              <i class="d-flex mt-1 mr-3 icon-communication-033 u-line-icon-pro"></i>
              <div class="media-body">
                0-800-77-SUSHI(78744)
              </div>
            </li>
          </ul>
          <!-- End Links -->
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-3 ml-auto g-mb-30">
          <h2 class="h5 g-color-gray-light-v3 mb-4">Seguinos en:</h2>
      ...
      <div class="col-md-6 text-md-right g-mb-20">
        <ul class="list-inline g-color-gray-dark-v5 g-font-size-25 mb-0">
          ...
          <li class="list-inline-item g-cursor-pointer mx-1">
            <i class="fa fa-cc-amex" title="American Express"
               data-toggle="tooltip"
               data-placement="top"></i>
          </li>
          <li class="list-inline-item g-cursor-pointer mx-1">
      ...
      <div class="col-sm-6">
        <div class="g-pl-30 g-pl-20--sm g-pr-30 g-py-20">
          ...
          <div class="g-mb-35">
            ...
            <p class="g-font-weight-300 g-color-primary g-font-size-16">Get free promotions every
              month!</p>
          </div>
          <!-- End Info -->
