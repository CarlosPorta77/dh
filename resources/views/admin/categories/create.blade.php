...
@section('content')
  ...
  <div class="container g-pt-20 g-pb-20">
    <header class="text-center mb-4">
      <h1 class="h3 g-color-black g-font-weight-400">Nueva categoría</h1>
    </header>

    <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30" method="post" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <button class="btn btn-lg u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25 g-mr-10" type="submit">Guardar</button>

      <a href="{{ route('admin.categories.index') }}" class="btn btn-lg u-btn-bluegray g-font-size-12 text-uppercase g-py-12 g-px-25" type="submit">Cancelar</a>
