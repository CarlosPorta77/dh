...
@section('content')
  ...
  <div class="container g-pt-20 g-pb-20">
    ...
    <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30" method="post" action="{{ route('admin.categories.store') }}">
    {{ csrf_field() }}
    ...
    <!-- name -->
      ...
      <button class="btn btn-lg u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25 g-mr-10" type="submit">Registrar categoría</button>
